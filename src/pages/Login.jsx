    ...
    <div className="min-h-screen pt-32 pb-20 flex flex-col items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-10">
          <h1 className="text-4xl font-display text-(--text-primary) mb-3">WELCOME BACK</h1>
          <p className="text-(--text-secondary) font-outfit">Enter your credentials to access your fleet.</p>
        </div>
        ...
        <div className="mt-8 text-center text-(--text-secondary) font-outfit">
          ...
          <Link to="/signup" className="text-(--text-primary) hover:text-accent transition-colors">Register Now</Link>
        </div>
      </motion.div>
    </div>
  )
